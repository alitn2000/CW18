...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Core.Bank.CardAggrigate.Entites.Card", b =>
                {
            ...
            modelBuilder.Entity("App.Domain.Core.Bank.TransactionAggrigate.Entite.TransAction", b =>
                {
            ...
            modelBuilder.Entity("App.Domain.Core.Bank.UserAggrigate.Entite.User", b =>
                {
            ...
            modelBuilder.Entity("App.Domain.Core.Bank.CardAggrigate.Entites.Card", b =>
                {
                    b.HasOne("App.Domain.Core.Bank.UserAggrigate.Entite.User", "User")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("App.Domain.Core.Bank.TransactionAggrigate.Entite.TransAction", b =>
                {
                    b.HasOne("App.Domain.Core.Bank.CardAggrigate.Entites.Card", "DestinationCard")
                        .WithMany("DestinationCards")
                        .HasForeignKey("DestinationCardNumber")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("App.Domain.Core.Bank.CardAggrigate.Entites.Card", "SourceCard")
